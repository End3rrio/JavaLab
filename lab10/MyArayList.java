...
public class MyArayList <T>{
    ...
    public MyArayList(MyArayList<T> other){
    ...
    public boolean addAll(int index, MyArayList<T> other){
    ...
    public MyArayList<T> subList(int start, int end){
        MyArayList<T> nl = new MyArayList<>();
